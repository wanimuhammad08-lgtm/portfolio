...
export const App: React.FC = () => {
  ...
  // Exact background URL from prompt
  const promptBgUrl = 'https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260729_022513_486985a2-ac8c-4278-91a8-071dcd9fcaff.png&w=1280&q=85';

  return (
    <main className="relative h-[100dvh] w-full overflow-hidden bg-black text-cream selection:bg-cream selection:text-black">
      {/* 1. LAYER DEFAULT (z-0): Full-bleed background image */}
